...
use Botble\Marketplace\Http\Middleware\AddProductSpecificationGlobalScopeForVendorMiddleware;
...
Route::group([
    ...
    Theme::registerRoutes(function () {
        ...
        Route::group([
            ...
            Route::middleware([CheckProductSpecificationEnabledMiddleware::class, AddProductSpecificationGlobalScopeForVendorMiddleware::class])->group(function () {
